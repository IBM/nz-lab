...
11. Change directories to the `FULL` folder with cd and display
	    the contents with `ls -l`:
...
12. Change directories to the data folder with the cd command
...
13. Now switch to the md folder using cd ../md and display the
	    contents with `ls -l`:
...
15. Switch back to the lab folder:
